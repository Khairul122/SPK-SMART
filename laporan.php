...
$nama_pimpinan = isset($_SESSION['pimpinan']) ? $_SESSION['pimpinan'] : 'Nama Pimpinan';
?>
<!DOCTYPE html>
<html>
...
<body>
	...
	<div class="container">
		<div>
			<h2 style="text-align:center;">Koperasi simpan pinjam syariah baitul mall tamwil (KSPPS BMT) Kampuang Jua</h2>
			<h4 style="text-align:center;">Jl. Parak Karakah, Kubu Marapalam, Kec. Padang Tim., Kota Padang</h4>
			<hr style="width:100%; margin:auto; border:1px solid black;">
		</div>
	...
	<div>
		<p style="text-align: right;margin-right: 400px;">Padang, <?php echo date('d-m-Y'); ?></p>
		<p style="text-align: right;margin-right: 480px;">Pimpinan</p>
		<br /><br /> <br />
		<p style="text-align: right;margin-right: 430px;"><?php echo htmlspecialchars($nama_pimpinan); ?></p>
	</div>
